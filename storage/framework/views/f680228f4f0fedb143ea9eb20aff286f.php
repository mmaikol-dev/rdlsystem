        ...
        <div class="header-content">
            ...
            <div class="meta-wrapper">
                <table class="meta">
                    <tr>
                        <th>Print Date</th>
                        <td><?php echo e($printDate); ?></td>
                    </tr>
                    <tr>
                        <th>Rider / Agent</th>
                        <td><?php echo e($agent); ?></td>
                    </tr>
                    <tr>
                        <th>Total Orders</th>
                        <td><?php echo e(count($orders)); ?></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <tbody>
            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="col-date">
                        <?php echo e($order->delivery_date ? \Carbon\Carbon::parse($order->delivery_date)->format('M d, Y') : 'Not set'); ?>
...
<?php /**PATH /home/maikol1/projects-2026/callcenter working/resources/views/orderspdf.blade.php ENDPATH**/ ?>